...
[OBS](https://obsproject.com/)（Open Broadcaster Software）是一款广受欢迎的免费开源视频录制与直播软件，支持 Windows、Mac 和 Linux 平台。大部分直播软件都是基于 OBS 内核开发的。它的强大功能和高度定制性，使其成为直播入门的首选工具。本文将带你从基础认识 OBS，掌握其设置和使用方法，让你的直播之旅起步更加顺畅。
...
在直播之前，通过右上角菜单栏中的「文件」>「设置」调整 OBS 的配置以适配你的直播需求是非常重要的步骤。
...
OBS 不仅是一款功能强大、操作灵活的直播软件，它更是直播新手及专业主播深入了解直播技术的重要工具。通过本篇的引导，相信你已经对 OBS 有了初步的认识和掌握。

篇二将开启 OBS 插件的探索之旅，我们将深入了解如何通过插件进一步拓展 OBS 的功能，使你的直播更加专业、更具吸引力。
